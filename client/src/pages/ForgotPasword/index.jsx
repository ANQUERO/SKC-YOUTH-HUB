  ...
  const handleSendResetEmail = async (e) => {
    ...
    try {
      ...
      if (response.data.resetToken) {
        ...
        setMessage(
          `${response.data.message} (Development: Use this token: ${response.data.resetToken})`,
        );
      }
    } catch (err) {
            ...
            <CardContent sx={{ p: 4 }}>
              ...
              <form onSubmit={handleResetPassword}>
                ...
                <TextField
                  ...
                  required
                  sx={{ mb: 2 }}
                  helperText="At least 8 characters with uppercase, lowercase, a number, and a symbol"
                />
  ...
  return (
    <div className={style.container}>
      ...
      <div className={style.left}>
        <div className={style.text}>
          ...
          <p className={style.tagline}>
            Our philosophy is simple: transparency, engagement, and
            accountability.
          </p>
        </div>
      </div>
      ...
      <div className={style.right}>
        <Container maxWidth="sm">{renderStepContent()}</Container>
      </div>
    </div>
  );
};
