...
const OfficialSignup = () => {
    ...
    return (
        <Card className={styles.officialSignupCard}>
            <CardContent>
                <Typography variant="h6" gutterBottom className={styles.officialSignupHeader}>
                    <PersonAdd className={styles.icon} /> Register New Official
                </Typography>
                <Typography variant="body2" color="text.secondary" className={styles.officialSignupDescription}>
                    Add a new official to the system. Only super officials can register other officials.
                </Typography>

                {signupStatus && (
                    <Alert
                        severity={signupStatus.includes('error') || signupStatus.includes('Failed') ? 'error' : 'success'}
                ...
                <form onSubmit={handleOfficialSignup} className={styles.officialSignupForm}>
