  ...
  const validateCurrentStep = () => {
    ...
    switch (activeStep) {
      ...
      case 2: // Demographics, Survey, Meeting, Household
        ...
        if (!formData.registered_voter)
          newErrors.registered_voter = "Voter registration status is required";
        if (!formData.registered_national_voter)
          newErrors.registered_national_voter =
            "National voter registration status is required";
        if (!formData.vote_last_election)
          newErrors.vote_last_election =
            "Last election voting status is required";
        if (!formData.attended)
          newErrors.attended = "Meeting attendance status is required";
        ...
        if (!formData.household)
          newErrors.household = "Household information is required";
        break;
      ...
      case 3: // Verification (Email, Password, Attachment)
        ...
        if (!formData.attachment)
          newErrors.attachment = "Location validation document is required";
        break;
    }
    ...
    <Wrapper>
      <Container maxWidth="md">
        <Paper elevation={3} sx={{ p: 4, borderRadius: 2 }}>
          <h1 className={style.signupTitle}>Youth Registration</h1>
...
const Wrapper = styled.div`
  ...
  position: relative;
  align-items: center;
  background: linear-gradient(135deg, #5894e2, #15376c);
...
const StepIcon = styled.div`
  ...
  background-color: ${(props) =>
    props.$completed ? "#4caf50" : props.$active ? "#1976d2" : "#e0e0e0"};
